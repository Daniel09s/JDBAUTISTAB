export class formulario {
    ...
    buscarEstudiante() {
        const btnBuscar = document.getElementById('btn-buscar'); // Tratar como un elemento html
        const resultado = document.getElementById('resultado');
        const tipoD = document.getElementById('tipoDocumento');
        const numeroDocumento = document.getElementById('id');
